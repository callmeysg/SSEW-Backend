...
import com.singhtwenty2.ssew_core.data.dto.catalog_management.CategoryDTO.CategoryResponse;
import com.singhtwenty2.ssew_core.data.dto.catalog_management.CategoryDTO.CreateCategoryRequest;
import com.singhtwenty2.ssew_core.data.dto.catalog_management.CategoryDTO.UpdateCategoryRequest;
...
public class CategoryController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<GlobalApiResponse<Map<String, Object>>> activateCategory(
            @PathVariable String categoryId,
            HttpServletRequest request
    ) {
        log.info("Category activation attempt from IP: {} for ID: {}", getClientIP(request), categoryId);
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<GlobalApiResponse<Map<String, Object>>> deactivateCategory(
            @PathVariable String categoryId,
            HttpServletRequest request
    ) {
        log.info("Category deactivation attempt from IP: {} for ID: {}", getClientIP(request), categoryId);
